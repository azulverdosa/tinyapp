...
const urlDatabase = {
  b6UTxQ: {
    createdAt: '2022-03-22T23:51:28.732Z',
  ...
  i3BoGr: {
    createdAt: '2022-03-22T23:51:28.732Z',
    longUrl:
      'https://www.thisiscolossal.com/2014/03/absurdly-expressive-dog-portraits-by-elke-vogelsang/',
    userId: 'abcdef',
  },
};
...
app.post('/register', (req, res) => {
  ...
  if (findUserByEmail(givenEmail, userDatabase)) {
    return res
      .status(400)
      .send("Hmm, looks like you've done this before, the email already exists");
  }
...
app.post('/urls', (req, res) => {
  ...
  if (longUrl === '') {
    return res.status(400).send('Oops, did you forget something? Field cannot be blank');
  }
